        ...
        <div className="sidebar">
            <div className="sidebar-container">
                ...
                <div className="firendes">
                    <NavLink to="/Manger">
                        <ul>
                            <li><img src={volume} alt="" /> <span >Ads Manger</span> </li>
                        </ul>
                    </NavLink>
                </div>
                <div className="firendes">
            ...
            {/* <div className="sidebar-footer">
                <ul className="sidebar-collection">
                    <li className="sidebar-item"><h3>Your quick link</h3><p>Change</p></li>
                    <li className="sidebar-item"><img src="#" alt="" /> <h4>Dasturchilar/Developers</h4></li>
                    <li className="sidebar-item">
                        <span>Confidentiality  ·</span>
                        <span>Terms of Use  ·</span>
                        <span>Advertising  ·</span>
                        <span>Cookies ·</span>
                        <span> Choice of advertising  ·</span>
                        <span>Yet ·</span>
                        <span>Facebbok © 2021</span>
                    </li>
                </ul>
            </div> */}
        </div>
